              ...
              <FormItem>
                ...
                <FormControl>
                  <div className='relative'>
                    <Mail className={`absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 ${errors.email ? 'text-red-500' : 'text-yellow-500'}`} />
                    <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <div className='relative'>
                    <Lock className={`absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 ${errors.password ? 'text-red-500' : 'text-yellow-500'}`} />
                    <Input
      ...
      <div className='mt-6 text-center'>
        <p className='text-sm text-gray-600'>
          Don&apos;t have an account?{' '}
            <Link href='/signup' className='font-medium text-yellow-600 hover:text-yellow-500 underline underline-offset-4'>
            Create New Account
          </Link>
        </p>
      </div>
